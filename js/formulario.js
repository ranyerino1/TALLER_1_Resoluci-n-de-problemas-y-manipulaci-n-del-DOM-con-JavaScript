...
const validarFormulario = (e) => {
	...
	switch (e.target.name) {
		case "numDoc":
			validarCampo(expresiones.numeros, e.target, 'numDoc');
		break;
		case "nombre":
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.numDoc && campos.nombre && campos.apellido && campos.correo && campos.password && terminos.checked ){
		formulario.reset();
